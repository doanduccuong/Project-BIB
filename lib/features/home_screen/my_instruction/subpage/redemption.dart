...
class Redemption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      ...
      title: 'Redemption Instruction',
      bodyWidget: Column(
        children: [
          Spacer(),
          Button(callBack:()=>showDialog(context: context, builder: (context)=>SubmitSucess()),title: 'Submit Instruction',textColor: AppColors.textColor,backGroundColor: AppColors.mainBackGroundColor,height: 46,)
        ],
      ),
    );
  }
