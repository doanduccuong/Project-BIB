...
class SimpleBtn extends StatelessWidget {
  const SimpleBtn(
      {Key? key, this.onPressed,required this.child, this.focusMargin, this.normalColors, this.hoverColors, this.cornerRadius})
      : super(key: key);
  final Widget child;
  final VoidCallback? onPressed;
...
class IconBtn extends StatelessWidget {
  const IconBtn(this.icon, {Key? key, this.onPressed, this.color, this.padding}) : super(key: key);
  final IconData icon;
  final VoidCallback? onPressed;
  final Color? color;
