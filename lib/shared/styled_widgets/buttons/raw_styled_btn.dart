...
import 'package:base_flutter/shared/widgets/positioned_all.dart';
import 'package:base_flutter/shared/widgets/rounded_card.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:provider/provider.dart';

import 'package:base_flutter/shared/extensions/string_extension.dart';
import 'package:base_flutter/core_packages.dart';

import '../styled_spacers.dart';

class BtnColors {
  BtnColors({required this.bg, required this.fg, this.outline = Colors.transparent});
  final Color bg;
  final Color fg;
  final Color outline;
}
            ...
            child: TextButton(
              ...
              style: ElevatedButton.styleFrom(disabledMouseCursor: SystemMouseCursors.basic).copyWith(
                ...
                side: getMaterialState(
                    normal: BorderSide(color: normalColors.outline),
                    hover: BorderSide(color: hoverColors.outline)),
...
class BtnContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool hasLbl = label?.isNotNullOrEmpty() ?? false;
    // Add a touch of extra padding for touch users
    bool enableTouchMode = context.select((MainAppState m) => m.enableTouchMode);
