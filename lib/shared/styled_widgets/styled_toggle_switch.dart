import 'package:base_flutter/shared/styled_widgets/styled_tooltip.dart';
import 'package:base_flutter/shared/widgets/popover/popover_region.dart';
import 'package:flutter/material.dart';
import 'package:base_flutter/core_packages.dart';

import 'app_icons.dart';
import 'buttons/styled_btn.dart';
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: PopOverRegion.hover(
        popChild: StyledTooltip(label: toolTip),
